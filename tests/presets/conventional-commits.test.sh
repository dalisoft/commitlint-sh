...
test_commit_0_1_initial_message() {
  ...
  assert_status_code 0 "$ROOT_DIR/validate.sh \"$message\""
}
...
test_commit_7_fix_multi_message() {
  ...
  assert_status_code 0 "$ROOT_DIR/validate.sh --verbose \"$message\""
}
test_commit_8_revert_message() {
  ...
  assert_status_code 0 "$ROOT_DIR/validate.sh --quiet \"$message\""
}
